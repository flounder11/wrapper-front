...
export default function WrapperGenerator() {
	...
	const handleDone = async () => {
		try {
			// Здесь можно добавить логику для отправки данных на бекенд
			const response = await axios.post(
				...
				},
				{
					...
					responseType: 'blob', // Указываем, что ответ будет в виде blob (для загрузки файла)
				}
			)
		...
		<div className='wrapper-generator'>
			{step === 1 && (
				<div className='start-screen'>
					<h1>Сделай свою упаковочную бумагу!</h1>
						...
						<div className='upload-zone'>
							...
							{imageUrls.length >= 5 && (
								<p className='max-images-message'>
									Вы достигли максимального количества изображений (5).
								</p>
							)}
							<input
								type='file'
